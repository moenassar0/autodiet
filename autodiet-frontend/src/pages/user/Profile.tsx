                ...
                <div className="flex h-4/5 grow w-full bg-admin-grey-background dark:bg-ad-lightgrey">
                    <div className="flex flex-col h-4/5 w-5/6 py-2 px-2">
                        <div className="flex w-full h-1/6">
                            <div className="flex items-center w-1/5 h-full font-medium">Goal</div>
                        ...
                        <div className="flex w-full h-1/6">
                            <div className="flex items-center  w-1/5 h-full font-medium">Sex</div>
                        ...
                        <div className="flex items-center w-full h-1/6">
                            <div className="flex items-center w-1/5 h-full font-medium">Height</div>

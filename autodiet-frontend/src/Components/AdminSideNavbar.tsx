...
export const AdminSideNavbar = () => {
    ...
    return(
        <div style={{width:openNavbar ? "250px" : "50px"}}className={(openNavbar ? "" : "") + " ease-in duration-150 flex flex-wrap content-start items-center h-screen bg-admin-main overflow-auto"}>
